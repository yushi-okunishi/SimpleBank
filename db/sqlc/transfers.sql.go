...
INSERT INTO transfers (
  ...
  $1, $2, $3
) RETURNING id, from_account_id, to_acconut_id, amount, created_at
`

type CreateTransferParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAcconutID   int64 `json:"to_acconut_id"`
	Amount        int64 `json:"amount"`
}

func (q *Queries) CreateTransfer(ctx context.Context, arg CreateTransferParams) (Transfers, error) {
	row := q.db.QueryRowContext(ctx, createTransfer, arg.FromAccountID, arg.ToAcconutID, arg.Amount)
	var i Transfers
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
...
SELECT id, from_account_id, to_acconut_id, amount, created_at FROM transfers
WHERE id = $1 LIMIT 1
`
